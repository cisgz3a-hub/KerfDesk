...
| Logo Line Art trace | The real Arch House/Langebaan source fixture now passes the Line Art acceptance gate. | Built-dirty | `audit/fixtures/trace/arch-house-langebaan-source.png`, `src/__fixtures__/perceptual/arch-house-baseline.test.ts`, `audit/reports/trace-quality-loop-baseline-2026-06-25.md` | Preserve this baseline before changing trace modes again. |
