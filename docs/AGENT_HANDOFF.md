...
- Last shipped roadmap item: **T2-6 Phase 3ad** (start-mode selection scene update and WCS-reset decision extracted from App.tsx, shipped in `a245ff85`).
