...
Scanned 2637 source files, excluding named .test/.spec files and **fixtures** but including helper modules. Found **817 control definitions and component calls** across 22 UI areas, plus **94 command IDs**. These are source records, not visible button counts or runtime passes.

Base commit: `35b873829c9eb6681d52cc966dc7e15564be4360`. SHA-256 of scanned paths and source contents: `46a5737e33d88d6fd46d90f49496b6f12229e8a0d38074f4bad895f03cbd93ad`.
...
652 records have nearby test pointers; 165 do not. A pointer is a navigation aid, not measured test coverage. 5 records have heuristic review flags; their disposition is in the findings document.
