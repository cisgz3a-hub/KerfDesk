...
Scanned 2626 source files, excluding named .test/.spec files and **fixtures** but including helper modules. Found **805 control definitions and component calls** across 22 UI areas, plus **91 command IDs**. These are source records, not visible button counts or runtime passes.

Base commit: `377e692baf26a9f66ba3877f157213095c54b92f`. SHA-256 of scanned paths and source contents: `e886c12cb5eb8f9163de8d49a247ddd79a4d1a1e73233285647458595776e5d3`.
...
654 records have nearby test pointers; 151 do not. A pointer is a navigation aid, not measured test coverage. 5 records have heuristic review flags; their disposition is in the findings document.
...
| laser.home                               |                       2 |                           2 |
| window.toggle-preview                    |                       1 |                           7 |
| window.toggle-layers-panel               |                       1 |                           3 |
| window.toggle-machine-panel              |                       1 |                           3 |
| window.toggle-side-panels                |                       1 |                           3 |
| window.reset-layout                      |                       1 |                           2 |
| window.fit-view                          |                       1 |                           3 |
| window.project-notes                     |                       1 |                           2 |
| window.undo-history                      |                       1 |                           2 |
| help.about                               |                       1 |                           2 |
| help.tutorials                           |                       1 |                           2 |
| help.connection                          |                       1 |                           2 |
| help.safety                              |                       1 |                           2 |
