...
- Regression tests: `console-command.test.ts`, `laser-store-console-realtime.test.ts`,
  ...
  `laser-home-silent-grbl.test.ts`, `laser-home-silent-grblhal.simulator.test.ts`,
  `laser-alarm-report-repeat.test.ts`, `laser-home-falcon-relock.test.ts`,
  `laser-parser-rearm.test.ts`,
