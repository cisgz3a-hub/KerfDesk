// Original Hershey Roman Simplex vector data.
//
// The Hershey Fonts were originally created by Dr. A. V. Hershey while
// working at the U. S. National Bureau of Standards. The format of this
// distribution was created by James Hurt, Cognition, Inc.
// Redistribution is permitted for any purpose with those acknowledgements;
// converted data must not use the restricted U.S. NTIS distribution format.
// Source distribution: https://github.com/bjnortier/hershey

export const HERSHEY_SIMPLEX_JHF: ReadonlyArray<string> = [
  '  699  1JZ',
