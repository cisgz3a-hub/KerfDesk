...
// ADR-327: an anchor names a PHYSICAL corner of the artwork (front = toward the
...
describe('anchorPointForOrigin: anchors are physical corners on every device origin (ADR-327)', () => {
