...
import type {
  RouteCandidate,
  RouteReconciliationInput,
  RouteReconciliationState,
} from './live-route-reconciliation';

// Test oracle: reconcileReportedPosition as it shipped before the execution
// window (90c791c5f), kept verbatim apart from the name. Its scan runs from
// confirmed progress to the acknowledged ceiling however far that is, so while
// confirmed progress is within one window of the ceiling the windowed scan
...
export function legacyReconcileReportedPosition(
