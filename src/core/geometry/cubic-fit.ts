...
function fitRecursive(
  ...
  fitRecursive(points, first, split, tangentStart, negate(centered), tolerance, out, depth + 1);
  fitRecursive(points, split, last, centered, tangentEnd, tolerance, out, depth + 1);
}
