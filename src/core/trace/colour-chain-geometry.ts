...
import type { CubicPathSegment, Vec2 } from '../scene';
// Not on the scene barrel, which the index-export ratchet pins (ADR-015).
import type { LinePathSegment } from '../scene/scene-object';
