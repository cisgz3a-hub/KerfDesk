 ...
 * ADR-159 amendment 2's SVG arcs imported as cubics that meet the arc at each
 * segment midpoint instead of sitting up to 0.196% of the radius inside it.
 */
  ...
  if (assumed.controllerKind === 'marlin') {
    ...
    return dialect.powerMode === 'fan'
      ...
      : [
          ...
          '; mode-boundaries: M5 I drains motion and disables power before inline re-entry',
