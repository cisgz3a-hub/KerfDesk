...
export function requireDither(obj: Record<string, unknown>, path: string): string | null {
  return requireLiteral(obj, path, DITHER_ALGORITHMS);
}

export function optionalDither(obj: Record<string, unknown>, path: string): string | null {
  return optionalLiteral(obj, path, DITHER_ALGORITHMS);
}

export function requireOrigin(obj: Record<string, unknown>, path: string): string | null {
