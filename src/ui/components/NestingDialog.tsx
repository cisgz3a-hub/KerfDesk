    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('div', null,
          React.createElement('div', { style: { color: '#e0e0ec', fontSize: 14, fontWeight: 600 } }, 'Auto-Nest Shapes'),
          React.createElement('div', { style: { color: '#555570', fontSize: 10, marginTop: 2 } }, 'Pack shapes efficiently to save material'),
        ),
      ...
      React.createElement('div', {
        ...
        }, `Apply Nesting (${placedCount} shapes)`),
      ),
    ),
  );
}
