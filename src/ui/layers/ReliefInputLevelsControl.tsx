  ...
  return (
    <div role="group" aria-label="Relief input levels" style={groupStyle}>
      ...
      <span style={explanationStyle}>
        {
          'Source codes are 0–65535. Low < high clips outside the endpoints and redistributes the range. Crossed endpoints reverse the response and are valid. Equal endpoints produce a flat normalized 0.5 before the stored curve and polarity.'
        }
      </span>
    </div>
  );
