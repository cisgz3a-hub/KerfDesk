// CameraOverlay — the live overhead-camera frame (ADR-094), warped by the
...
export function CameraOverlay(props: CameraOverlayProps): JSX.Element {
  ...
  return (
    <video
      ...
      playsInline
      aria-hidden="true"
      onLoadedMetadata={(e) => setFrame({ width: e.currentTarget.videoWidth, height: e.currentTarget.videoHeight })}
      style={{
        position: 'absolute',
        top: 0,
        left: 0,
