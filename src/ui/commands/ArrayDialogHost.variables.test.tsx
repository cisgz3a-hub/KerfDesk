...
describe('visible per-copy variable grid workflow', () => {
  ...
  it('keeps the dialog open on a CSV error and leaves the source untouched', async () => {
  ...
  it('cancels a pending render without applying any copies', async () => {
  ...
  it('discards a late result after the source project changes', async () => {
    let release = (): void => undefined;
    const wait = new Promise<void>((resolve) => {
      release = resolve;
    });
