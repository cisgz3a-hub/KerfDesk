...
const G_CODES = new Map<number, string>([
  ...
  [73, 'High-speed peck drilling cycle — short lifts to break chips'],
  [80, 'Cancel the canned cycle'],
  [81, 'Drilling cycle — plunge to Z, then retract'],
  [82, 'Drilling cycle with a dwell at the bottom'],
  [83, 'Peck drilling cycle — full retract each peck to clear chips'],
  [98, 'Canned cycles retract to the height they started from'],
  [99, 'Canned cycles retract to the R plane'],
...
const LETTERS: Readonly<Record<string, string>> = {
  ...
  R: 'Arc radius, or the canned-cycle retract plane',
  F: 'Feed rate',
  S: 'Spindle speed or laser power',
  P: 'Parameter — dwell seconds for G4',
  Q: 'Peck depth for a drilling cycle',
  T: 'Select tool',
