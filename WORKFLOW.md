...
- **Toasts**: overlay the top-centre of the canvas under the view switch, not the rails. Success confirmations dismiss after 4 s; advisories and failures after 8 s.
