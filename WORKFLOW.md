...
- **Job actions dock**: Frame and the primary **Set up & Frame** / **Start framed job** action sit outside the settings scroller. In Compact layout the dock remains below either the Artwork or Machine tab; in Spacious layout it sits below the expanded Machine panel. It shares the existing readiness, Frame, and Start handlers. A completed Frame for the exact reviewed job remains the sole ordinary Start policy gate; the dock adds no policy checks or machine actions.
