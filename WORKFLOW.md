...
### F-CNC46. Import an explicit top-down height map - Phase H.4 / P2R.1a (ADR-290/292/294/295)
...
4. The durable model is canonical U16 little-endian (`u16le-base64-v1`). The exact
...
> **Planned - not current UI.** P2R.1a plus ADR-294/295 supply schema-v4/U16LE
