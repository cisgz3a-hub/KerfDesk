...
- **Text (Phase D):** `opentype.js` (MIT) for outlines. Bundled permissive fonts (Roboto Apache-2.0; Tinos / Inconsolata / Pacifico / Dancing Script / Relief SingleLine / three reviewed EMS stroke faces OFL-1.1).
