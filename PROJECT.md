...
| P2R.1 | Schema-v4 canonical U16 field; lossless legacy migration; 8/16-bit grayscale, alpha/mask, tonal mapping, external-relative input; self-contained manual save and atomic autosave | In progress — P2R.1a built under ADR-292: schema v4/U16LE, v3 migration, manual-file persistence, worker-backed 8-bit grayscale plus simple `tRNS` mask, and existing CAM/previews. 16-bit PNG, full alpha/mask UI, tonal/source-mode UI, large atomic autosave, and exact edge-cell containment remain planned |
| P2R.1 | Schema-v4 canonical U16 field; lossless legacy migration; 8/16-bit grayscale, alpha/mask, tonal mapping, external-relative input; self-contained manual save and atomic autosave | In progress — P2R.1a built under ADR-292/293: schema v4/U16LE, v3 migration, manual-file persistence, worker-backed 8-bit grayscale plus simple `tRNS` mask, existing CAM/previews, and atomic whole-project IndexedDB autosave/recovery qualified for committed Chrome state across reload. Abrupt-process and packaged-Electron recovery, 16-bit PNG, full alpha/mask UI, tonal/source-mode UI, and exact edge-cell containment remain planned |
| P2R.1 | Schema-v4 canonical U16 field; lossless legacy migration; 8/16-bit grayscale, alpha/mask, tonal mapping, external-relative input; self-contained manual save and atomic autosave | In progress — P2R.1a built under ADR-292/293/294: schema v4/U16LE, v3 migration, manual-file persistence, worker-backed 8-bit grayscale plus simple `tRNS` mask, logical partial-edge CAM with disclosed preview/emitter precision, and atomic whole-project IndexedDB autosave/recovery qualified for committed Chrome state across reload. Abrupt-process and packaged-Electron recovery, 16-bit PNG, full alpha/mask UI, and tonal/source-mode UI remain planned |
