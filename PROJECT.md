...
| P2R.1 | Schema-v4 canonical U16 field; lossless legacy migration; 8/16-bit grayscale, alpha/mask, tonal mapping, external-relative input; self-contained manual save and atomic autosave | In progress — P2R.1a built under ADR-292/294/295/296/297/298: schema v4/U16LE, v3 migration, manual-file persistence, worker-backed exact 8/16-bit grayscale plus simple `tRNS` masks and exact 8-bit grayscale-alpha masks, persisted-threshold outside-mask meaning, exact U16 input-endpoint mapping, logical partial-edge CAM with disclosed preview/emitter precision, and existing CAM/previews. Large atomic autosave, 16-bit alpha, threshold/mask editing, gamma, histogram/clipping disclosure, crop/aspect controls, and source-mode UI remain planned |
