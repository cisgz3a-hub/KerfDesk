...
> **Current project format:** schema v5 adds operation-owned artwork overrides (ADR-317).
> The v4→v5 migration preserves existing operation identities and legacy global settings.
> This ownership extension does not change the relief coordinate/scale representation or close
