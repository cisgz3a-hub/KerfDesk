...
> **Current project format:** schema v5 adds operation-owned artwork overrides (ADR-316).
...
when **Add operation** creates a separately editable copy (ADR-316).
