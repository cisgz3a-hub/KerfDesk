...
| H.12 | Easel-parity pack (ADR-105): persistent live 3D pane, pocket raster fill (offset/raster-X/raster-Y), bundled local design library | Built; live 3D pane not shown since 2026-08-03 (#633, ADR-288) — use Preview's 3D button instead (H.11, F-CNC23) |
...
- *(Laser area-only second pass promoted to implementation on 2026-09-22, ADR-341:
