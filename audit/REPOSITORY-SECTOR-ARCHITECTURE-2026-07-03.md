...
|---|---:|---:|---|
| S01 | Governance, audit history, and product contracts | 223 | `CLAUDE.md`, `PROJECT.md`, `WORKFLOW.md`, `DECISIONS.md`, `AUDIT.md`, `README.md`, `CONTRIBUTING.md`, `LICENSE`, `RESEARCH_LOG.md`, `THIRD_PARTY_NOTICES.md`, `AUDIT-*.md`, `FEATURE-AUDIT-*.md`, `FIXES-*.md`, `LIGHTBURN-*.md`, `MATERIAL-*.md`, `docs/**`, `audit/**` |
...
| S04 | Core domain models, controller/device/material primitives | 109 | `src/core/app-branding.ts`, `src/core/camera/**`, `src/core/controllers/**`, `src/core/devices/**`, `src/core/geometry/**`, `src/core/grbl-streaming.ts`, `src/core/material-library/**`, `src/core/scene/**`, `src/core/shapes/**`, `src/core/text/**`, `src/core/util/**` |
| S05 | Core job compilation, preflight, raster/trace, and output | 177 | `src/core/invariants/**`, `src/core/job/**`, `src/core/output/**`, `src/core/preflight/**`, `src/core/raster/**`, `src/core/trace/**` |
| S06 | IO formats and persistence | 69 | `src/io/**` |
| S07 | Platform adapters | 12 | `src/platform/**` |
| S08 | UI application workflows | 564 | `src/ui/**`, `src/vite-env.d.ts` |
| S09 | Fixtures, perceptual harness, and test assets | 43 | `src/__fixtures__/**`; local ignored evidence may also appear under `perceptual-artifacts/**` |
