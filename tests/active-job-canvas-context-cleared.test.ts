...
import { type ControllerOutput, type ControllerJobTicket, type LaserController, type JobProgress, type MachineState } from '../src/controllers/ControllerInterface';
import {
  createBlankProfile,
  getActiveProfile,
  saveDeviceProfile,
