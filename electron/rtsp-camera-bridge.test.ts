...
describe('RTSP camera bridge request policy', () => {
  it('allows only packaged-app and loopback-development origins', () => {
    ...
    expect(cameraBridgeCorsOrigin('https://kerfdesk.com')).toBeNull();
    expect(cameraBridgeCorsOrigin('https://laserforge-2fj.pages.dev')).toBeNull();
